...
export const PageTransition: React.FC<PageTransitionProps> = ({ children }) => {
  // Cinematic "Tech" easing: Fast acceleration, smooth deceleration
  const ease = [0.87, 0, 0.13, 1] as const;

  // Duration of the "Hold" phase (Reduced for speed)
  ...
  const voidVariants = {
    ...
    animate: { 
      ...
      transition: { 
        duration: 0.8, 
        ease: ease,
        delay: holdDuration - 0.1 // Start slightly before neon leaves for layering effect
      } 
    },
    exit: { 
      x: ["100%", "0%"], 
