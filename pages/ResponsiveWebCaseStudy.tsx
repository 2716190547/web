...
const ResponsiveWebCaseStudy: React.FC = () => {
    ...
    const content = {
        hero: {
            ...
            subtitle: isZh ? "多端适配设计" : "RESPONSIVE WEB DESIGN",
            desc: isZh
                ? "专注于多端设备适配的网站设计项目，确保在不同屏幕尺寸和设备上都能提供优质的用户体验和视觉呈现。"
                : "Website design project focusing on multi-device adaptation, ensuring excellent user experience and visual presentation across different screen sizes and devices.",
            brand: "Web Design"
        }
    };
    ...
    return (
        <div className="min-h-screen bg-transparent relative z-10 pt-24 pb-20 px-4 md:px-8 overflow-x-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <div className="flex flex-col gap-6">
                        {[31, 32, 33, 34, 35, 36, 37, 38].map((num, index) => (
                            <motion.div
                                key={num}
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
...
export default ResponsiveWebCaseStudy;
