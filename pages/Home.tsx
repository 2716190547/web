...
const projects = [
  { 
    id: 1, 
    title: "NEON GENESIS", 
    category_en: "WEB DESIGN / THREE.JS",
    category_zh: "网页设计 / THREE.JS", 
    year: "2024",
    img: "https://picsum.photos/seed/neon1/1920/1080" 
  },
  { 
    id: 2, 
    title: "VOID WALKER", 
    category_en: "BRANDING / MOTION",
    category_zh: "品牌 / 动态设计", 
    year: "2023",
    img: "https://picsum.photos/seed/void2/1920/1080" 
  },
  { 
    id: 3, 
    title: "CYBER STRUCT", 
    category_en: "ARCHITECTURE / 3D",
    category_zh: "建筑 / 3D渲染", 
    year: "2023",
    img: "https://picsum.photos/seed/arch/1920/1080" 
  },
  { 
    id: 4, 
    title: "MONO SYSTEM", 
    category_en: "UI/UX / SYSTEM",
    category_zh: "UI/UX / 设计系统", 
    year: "2022",
    img: "https://picsum.photos/seed/ui/1920/1080" 
  },
];
                 ...
                 >
                    <Link to="/work" className="block w-full h-full relative">
                        ...
                        >
                           ...
                           >
                              <h3 className="font-display font-black text-4xl text-white rotate-90 whitespace-nowrap tracking-widest uppercase mix-blend-overlay">
                                 {project.title}
                              </h3>
                           </div>
                           ...
                           `}>
                               ...
                               <h3 className="font-display font-black text-4xl md:text-7xl text-white leading-none mb-4 md:mb-8 tracking-tighter whitespace-nowrap">
                                 {project.title}
                               </h3>
